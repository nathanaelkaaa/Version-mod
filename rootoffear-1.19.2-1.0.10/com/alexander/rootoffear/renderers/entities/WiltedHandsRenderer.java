...
/*    */ 
/*    */ @OnlyIn(Dist.CLIENT)
/*    */ public class WiltedHandsRenderer
/*    */   extends EntityRenderer<WiltedHands> {
/* 19 */   private static final ResourceLocation TEXTURE = new ResourceLocation("rootoffear", "textures/entity/decoy_wilted.png");
/*    */   private final WiltedHandsModel<WiltedHands> model;
/*    */   
/*    */   public WiltedHandsRenderer(EntityRendererProvider.Context context) {
/* 23 */     super(context);
/* 24 */     this.model = new WiltedHandsModel(context.m_174023_(WiltedHandsModel.LAYER_LOCATION));
/*    */   }
/*    */   
/*    */   public void render(WiltedHands entity, float p_115374_, float partialTick, PoseStack stack, MultiBufferSource buffer, int packedLight) {
/* 28 */     stack.m_85836_();
...
/*    */   }
/*    */   
/*    */   public ResourceLocation getTextureLocation(WiltedHands entity) {
/* 41 */     return TEXTURE;
/*    */   }
/*    */ }


/* Location:              C:\Users\Black\Desktop\Root of fear\rootoffear-1.19.2-1.0.10.jar!\com\alexander\rootoffear\renderers\entities\WiltedHandsRenderer.class
